    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="assets/images/icon/logohv.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Toan kim <i class="fa fa-angle-down"></i></h4>
                    ...
                    <form method="post" action="{{url('/add_role')}}">
                        ...
                        <div class="login-form-body">
                            <div class="form-gp">
                                ...
                                <input type="text" id="exampleInputName1" name="name_role">
                                <i class="ti-user"></i>
