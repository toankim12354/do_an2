                   ...
                   height: 100%; margin: 50px auto;"> 
                    ...
                    <div class="login-form-body">
                        <div class="form-group">
                            <label for="example-text-input" class="col-form-label"> Tên lớp </label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="tg_bat_dau" value="{{ old('tg_bat_dau', $lop_manager->tg_bat_dau) }}"  id="example-text-input" >
                            <div style="color: red">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date"  name="tg_bket_thuc" value="{{ old('tg_bket_thuc', $lop_manager->tg_bket_thuc) }}"  id="example-text-input" >
                            <div style="color: red">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="khoa_id" >
                                        <option>Select</option>
                                        @foreach ( $khoa as $k)
                                        @if ($lop_manager->khoa_id == $k->id )
                                        <option selected value="{{ $k->id }}">{{ $k->ten }}</option>
                                        @else
